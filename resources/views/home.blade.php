                        ...
                        <div class="row wt-separator-two-part-row">
                            <div class="col-xl-8 col-lg-8 col-md-12 wt-separator-two-part-left">
                                ...
                                <div class="section-head left wt-small-separator-outer">
                                    ...
                                    <h2 class="wt-title">Join our community of talented and professionals by applying for a job today!.</h2>
                                </div>                  
                                <!-- TITLE END-->
                            </div>
                        </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="counter-outer-two">
                                            ...
                                            <div class="icon-content">
                                                <div class="tw-count-number site-text-white">
                                                    <span class="counter text-clr-pink">40</span></div>
                                                <p class="icon-content-info">Our Offices</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6">
                                        <div class="counter-outer-two">
                                            ...
                                            <div class="icon-content">
                                                <div class="tw-count-number site-text-white">
                                                    <span class="counter text-clr-yellow-2">800</span></div>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6">
                                        <div class="counter-outer-two">
                                            ...
                                            <div class="icon-content">
                                                <div class="tw-count-number site-text-white">
                                                    <span class="counter text-clr-purple">3600</span></div>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6">
                                        <div class="counter-outer-two">
                                            ...
                                            <div class="icon-content">
                                                <div class="tw-count-number site-text-white">
                                                    <span class="counter text-clr-green">1590</span></div>
                                                <p class="icon-content-info">Completed Projects</p>
                                            </div>
                                        </div>
                                    </div>
